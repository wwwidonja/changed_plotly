    ...
    def __init__(self, plotly_name="treemap", parent_name="", **kwargs):
        super(TreemapValidator, self).__init__(
            ...
            customdatasrc
                ...
                for  customdata .
            domain
                :class:`new_plotly.graph_objects.treemap.Domain`
            ...
            level
                ...
                if `ids` is filled in, otherwise new_plotly
                attempts to find a matching item in `labels`.
            marker
                :class:`new_plotly.graph_objects.treemap.Marker`
                instance or dict with compatible properties
            maxdepth
            ...
            parents
                ...
                new_plotly attempts to find matching items in
                `labels`, but beware they must be unique.
            parentssrc
                Sets the source reference on Chart Studio Cloud
                for  parents .
            pathbar
                :class:`new_plotly.graph_objects.treemap.Pathbar`
                instance or dict with compatible properties
            root
                :class:`new_plotly.graph_objects.treemap.Root`
                instance or dict with compatible properties
            sort
                Determines whether or not the sectors are
                reordered from largest to smallest.
            stream
                :class:`new_plotly.graph_objects.treemap.Stream`
                instance or dict with compatible properties
            text
            ...
            texttemplatesrc
                ...
                for  texttemplate .
            tiling
                :class:`new_plotly.graph_objects.treemap.Tiling`
                instance or dict with compatible properties
            uid
