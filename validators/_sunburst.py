    ...
    def __init__(self, plotly_name="sunburst", parent_name="", **kwargs):
        super(SunburstValidator, self).__init__(
            ...
            customdatasrc
                ...
                for  customdata .
            domain
                :class:`new_plotly.graph_objects.sunburst.Domain`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.sunburst.Hoverlabe
            ...
            labelssrc
                ...
                for  labels .
            leaf
                :class:`new_plotly.graph_objects.sunburst.Leaf`
                instance or dict with compatible properties
            level
            ...
            marker
                :class:`new_plotly.graph_objects.sunburst.Marker`
                instance or dict with compatible properties
            maxdepth
            ...
            parentssrc
                ...
                for  parents .
            root
                :class:`new_plotly.graph_objects.sunburst.Root`
                instance or dict with compatible properties
            rotation
            ...
            stream
                :class:`new_plotly.graph_objects.sunburst.Stream`
                instance or dict with compatible properties
            text
