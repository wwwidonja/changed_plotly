    ...
    def __init__(self, plotly_name="pie", parent_name="", **kwargs):
        super(PieValidator, self).__init__(
            ...
            dlabel
                ...
                info.
            domain
                :class:`new_plotly.graph_objects.pie.Domain`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.pie.Hoverlabel`
                instance or dict with compatible properties
            hovertemplate
            ...
            marker
                :class:`new_plotly.graph_objects.pie.Marker`
                instance or dict with compatible properties
            meta
            ...
            stream
                :class:`new_plotly.graph_objects.pie.Stream`
                instance or dict with compatible properties
            text
            ...
            texttemplatesrc
                ...
                for  texttemplate .
            title
                :class:`new_plotly.graph_objects.pie.Title`
                instance or dict with compatible properties
            titlefont
