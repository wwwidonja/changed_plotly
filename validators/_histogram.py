...
class HistogramValidator(_plotly_utils.basevalidators.CompoundValidator):
    def __init__(self, plotly_name="histogram", parent_name="", **kwargs):
        super(HistogramValidator, self).__init__(
            ...
            cumulative
                :class:`new_plotly.graph_objects.histogram.Cumulati
            ...
            customdatasrc
                ...
                for  customdata .
            error_x
                :class:`new_plotly.graph_objects.histogram.ErrorX`
                instance or dict with compatible properties
            error_y
                :class:`new_plotly.graph_objects.histogram.ErrorY`
                instance or dict with compatible properties
            histfunc
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.histogram.Hoverlab
            ...
            marker
                :class:`new_plotly.graph_objects.histogram.Marker`
                instance or dict with compatible properties
            meta
            ...
            stream
                :class:`new_plotly.graph_objects.histogram.Stream`
                instance or dict with compatible properties
            text
            ...
            xbins
                :class:`new_plotly.graph_objects.histogram.XBins`
                instance or dict with compatible properties
            xcalendar
            ...
            ybins
                :class:`new_plotly.graph_objects.histogram.YBins`
                instance or dict with compatible properties
            ycalendar
