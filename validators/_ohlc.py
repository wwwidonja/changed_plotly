    ...
    def __init__(self, plotly_name="ohlc", parent_name="", **kwargs):
        super(OhlcValidator, self).__init__(
            ...
            customdatasrc
                ...
                for  customdata .
            decreasing
                :class:`new_plotly.graph_objects.ohlc.Decreasing`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.ohlc.Hoverlabel`
                instance or dict with compatible properties
            hovertext
                Same as `text`.
            hovertextsrc
            ...
            idssrc
                ...
                for  ids .
            increasing
                :class:`new_plotly.graph_objects.ohlc.Increasing`
                instance or dict with compatible properties
            legendgroup
            ...
            line
                :class:`new_plotly.graph_objects.ohlc.Line`
                instance or dict with compatible properties
            low
                Sets the low values.
            lowsrc
            ...
            stream
                :class:`new_plotly.graph_objects.ohlc.Stream`
                instance or dict with compatible properties
            text
