...
class VolumeValidator(_plotly_utils.basevalidators.CompoundValidator):
    def __init__(self, plotly_name="volume", parent_name="", **kwargs):
        super(VolumeValidator, self).__init__(
            ...
            caps
                :class:`new_plotly.graph_objects.volume.Caps`
            ...
            coloraxis
                ...
                axis.
            colorbar
                :class:`new_plotly.graph_objects.volume.ColorBar`
                instance or dict with compatible properties
            colorscale
            ...
            contour
                :class:`new_plotly.graph_objects.volume.Contour`
                instance or dict with compatible properties
            customdata
            ...
            lighting
                :class:`new_plotly.graph_objects.volume.Lighting`
                instance or dict with compatible properties
            lightposition
                :class:`new_plotly.graph_objects.volume.Lightpositi
            ...
            slices
                :class:`new_plotly.graph_objects.volume.Slices`
                instance or dict with compatible properties
            spaceframe
                :class:`new_plotly.graph_objects.volume.Spaceframe`
                instance or dict with compatible properties
            stream
                :class:`new_plotly.graph_objects.volume.Stream`
                instance or dict with compatible properties
            surface
                :class:`new_plotly.graph_objects.volume.Surface`
                instance or dict with compatible properties
            text
