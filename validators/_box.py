    ...
    def __init__(self, plotly_name="box", parent_name="", **kwargs):
        super(BoxValidator, self).__init__(
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.box.Hoverlabel`
            ...
            line
                :class:`new_plotly.graph_objects.box.Line` instance
            ...
            lowerfencesrc
                ...
                for  lowerfence .
            marker
                :class:`new_plotly.graph_objects.box.Marker`
                instance or dict with compatible properties
            mean
            ...
            sdsrc
                ...
                for  sd .
            selected
                :class:`new_plotly.graph_objects.box.Selected`
                instance or dict with compatible properties
            selectedpoints
            ...
            stream
                :class:`new_plotly.graph_objects.box.Stream`
                instance or dict with compatible properties
            text
            ...
            unselected
                :class:`new_plotly.graph_objects.box.Unselected`
                instance or dict with compatible properties
            upperfence
