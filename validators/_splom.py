    ...
    def __init__(self, plotly_name="splom", parent_name="", **kwargs):
        super(SplomValidator, self).__init__(
            ...
            customdatasrc
                ...
                for  customdata .
            diagonal
                :class:`new_plotly.graph_objects.splom.Diagonal`
                instance or dict with compatible properties
            dimensions
                A tuple of
                :class:`new_plotly.graph_objects.splom.Dimension`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.splom.Hoverlabel`
                instance or dict with compatible properties
            hovertemplate
            ...
            marker
                :class:`new_plotly.graph_objects.splom.Marker`
                instance or dict with compatible properties
            meta
            ...
            selected
                :class:`new_plotly.graph_objects.splom.Selected`
                instance or dict with compatible properties
            selectedpoints
            ...
            showupperhalf
                ...
                half from the diagonal are displayed.
            stream
                :class:`new_plotly.graph_objects.splom.Stream`
                instance or dict with compatible properties
            text
            ...
            unselected
                :class:`new_plotly.graph_objects.splom.Unselected`
                instance or dict with compatible properties
            visible
