    ...
    def __init__(self, plotly_name="mesh3d", parent_name="", **kwargs):
        super(Mesh3DValidator, self).__init__(
            ...
            coloraxis
                ...
                axis.
            colorbar
                :class:`new_plotly.graph_objects.mesh3d.ColorBar`
            ...
            contour
                :class:`new_plotly.graph_objects.mesh3d.Contour`
                instance or dict with compatible properties
            customdata
            ...
            lighting
                :class:`new_plotly.graph_objects.mesh3d.Lighting`
                instance or dict with compatible properties
            lightposition
                :class:`new_plotly.graph_objects.mesh3d.Lightpositi
            ...
            stream
                :class:`new_plotly.graph_objects.mesh3d.Stream`
                instance or dict with compatible properties
            text
