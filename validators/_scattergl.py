    ...
    def __init__(self, plotly_name="scattergl", parent_name="", **kwargs):
        super(ScatterglValidator, self).__init__(
            ...
            dy
                ...
                info.
            error_x
                :class:`new_plotly.graph_objects.scattergl.ErrorX`
                instance or dict with compatible properties
            error_y
                :class:`new_plotly.graph_objects.scattergl.ErrorY`
                instance or dict with compatible properties
            fill
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.scattergl.Hoverlab
            ...
            line
                :class:`new_plotly.graph_objects.scattergl.Line`
                instance or dict with compatible properties
            marker
                :class:`new_plotly.graph_objects.scattergl.Marker`
                instance or dict with compatible properties
            meta
            ...
            stream
                :class:`new_plotly.graph_objects.scattergl.Stream`
                instance or dict with compatible properties
            text
