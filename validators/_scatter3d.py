    ...
    def __init__(self, plotly_name="scatter3d", parent_name="", **kwargs):
        super(Scatter3DValidator, self).__init__(
            ...
            customdatasrc
                ...
                for  customdata .
            error_x
                :class:`new_plotly.graph_objects.scatter3d.ErrorX`
                instance or dict with compatible properties
            error_y
                :class:`new_plotly.graph_objects.scatter3d.ErrorY`
                instance or dict with compatible properties
            error_z
                :class:`new_plotly.graph_objects.scatter3d.ErrorZ`
                instance or dict with compatible properties
            hoverinfo
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.scatter3d.Hoverlab
            ...
            line
                :class:`new_plotly.graph_objects.scatter3d.Line`
                instance or dict with compatible properties
            marker
                :class:`new_plotly.graph_objects.scatter3d.Marker`
                instance or dict with compatible properties
            meta
            ...
            stream
                :class:`new_plotly.graph_objects.scatter3d.Stream`
                instance or dict with compatible properties
            surfaceaxis
