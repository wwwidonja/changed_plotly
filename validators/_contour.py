    ...
    def __init__(self, plotly_name="contour", parent_name="", **kwargs):
        super(ContourValidator, self).__init__(
            ...
            coloraxis
                ...
                axis.
            colorbar
                :class:`new_plotly.graph_objects.contour.ColorBar`
            ...
            connectgaps
                ...
                false.
            contours
                :class:`new_plotly.graph_objects.contour.Contours`
                instance or dict with compatible properties
            customdata
            ...
            line
                :class:`new_plotly.graph_objects.contour.Line`
                instance or dict with compatible properties
            meta
            ...
            stream
                :class:`new_plotly.graph_objects.contour.Stream`
                instance or dict with compatible properties
            text
