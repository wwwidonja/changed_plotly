    ...
    def __init__(self, plotly_name="scatterpolargl", parent_name="", **kwargs):
        super(ScatterpolarglValidator, self).__init__(
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.scatterpolargl.Hov
            ...
            line
                :class:`new_plotly.graph_objects.scatterpolargl.Lin
            ...
            stream
                :class:`new_plotly.graph_objects.scatterpolargl.Str
            ...
            texttemplate
                ...
                `arrayOk: true`) are available. variables `r`,
                `theta` and `text`.
            texttemplatesrc
                Sets the source reference on Chart Studio Cloud
                for  texttemplate .
