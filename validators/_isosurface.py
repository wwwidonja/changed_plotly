...
class IsosurfaceValidator(_plotly_utils.basevalidators.CompoundValidator):
    def __init__(self, plotly_name="isosurface", parent_name="", **kwargs):
        super(IsosurfaceValidator, self).__init__(
            ...
            caps
                :class:`new_plotly.graph_objects.isosurface.Caps`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.isosurface.Hoverla
            ...
            lighting
                :class:`new_plotly.graph_objects.isosurface.Lightin
                g` instance or dict with compatible properties
            lightposition
                :class:`new_plotly.graph_objects.isosurface.Lightpo
            ...
            slices
                ...
                instance or dict with compatible properties
            spaceframe
                :class:`new_plotly.graph_objects.isosurface.Spacefr
