    ...
    def __init__(self, plotly_name="bar", parent_name="", **kwargs):
        super(BarValidator, self).__init__(
            ...
            dy
                ...
                info.
            error_x
                :class:`new_plotly.graph_objects.bar.ErrorX`
                instance or dict with compatible properties
            error_y
                :class:`new_plotly.graph_objects.bar.ErrorY`
                instance or dict with compatible properties
            hoverinfo
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.bar.Hoverlabel`
                instance or dict with compatible properties
            hovertemplate
            ...
            marker
                :class:`new_plotly.graph_objects.bar.Marker`
                instance or dict with compatible properties
            meta
            ...
            outsidetextfont
                ...
                bar.
            selected
                :class:`new_plotly.graph_objects.bar.Selected`
                instance or dict with compatible properties
            selectedpoints
            ...
            stream
                :class:`new_plotly.graph_objects.bar.Stream`
                instance or dict with compatible properties
            text
            ...
            unselected
                :class:`new_plotly.graph_objects.bar.Unselected`
                instance or dict with compatible properties
            visible
