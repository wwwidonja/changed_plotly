    ...
    def __init__(self, plotly_name="cone", parent_name="", **kwargs):
        super(ConeValidator, self).__init__(
            ...
            coloraxis
                ...
                axis.
            colorbar
                :class:`new_plotly.graph_objects.cone.ColorBar`
            ...
            hoverinfosrc
                ...
                for  hoverinfo .
            hoverlabel
                :class:`new_plotly.graph_objects.cone.Hoverlabel`
                instance or dict with compatible properties
            hovertemplate
            ...
            lighting
                :class:`new_plotly.graph_objects.cone.Lighting`
                instance or dict with compatible properties
            lightposition
            ...
            sizeref
                ...
                vector norm.
            stream
                :class:`new_plotly.graph_objects.cone.Stream`
                instance or dict with compatible properties
            text
