...
docs = dict(
    ...
    symbol_sequence=[
        "list of str",
        "Strings should define valid new_plotly.js symbols.",
    ...
    symbol_map=[
        ...
        "String values should define new_plotly.js symbols",
    ...
    line_dash_map=[
        "dict with str keys and str values (default `{}`)",
        "Strings values define new_plotly.js dash-patterns.",
    ...
    line_dash_sequence=[
        "list of str",
        "Strings should define valid new_plotly.js dash-patterns.",
    ...
    color_discrete_sequence=[
        ...
        "Various useful color sequences are available in the `new_plotly.express.colors` submodules, specifically `new_plotly.express.colors.qualitative`.",
    ],
    color_discrete_map=[
        "dict with str keys and str values (default `{}`)",
    ...
    color_continuous_scale=[
        ...
        "Various useful color scales are available in the `new_plotly.express.colors` submodules, specifically `new_plotly.express.colors.sequential`, `new_plotly.express.colors.diverging` and `new_plotly.express.colors.cyclical`.",
    ],
    color_continuous_midpoint=[
        "number (default `None`)",
        "If set, computes the bounds of the continuous color scale to have the desired midpoint.",
        "Setting this value is recommended when using `new_plotly.express.colors.diverging` color scales as the inputs to `color_continuous_scale`.",
    ],
    ...
    template=[
        "str or dict or new_plotly.graph_objects.layout.Template instance",
        "The figure template name (must be a key in new_plotly.io.templates) or definition.",
    ],
    ...
    mapbox_style=[
        ...
        "Identifier of base map style, some of which require a Mapbox API token to be set using `new_plotly.express.set_mapbox_access_token()`.",
...
def make_docstring(fn, override_dict={}, append_dict={}):
    ...
    result += "\nReturns\n-------\n"
    result += "    new_plotly.graph_objects.Figure"
    return result
