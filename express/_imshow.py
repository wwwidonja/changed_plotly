...
def imshow(
    ...
    binary_string: bool, default None
        ...
        then passed to new_plotly.js as a b64 PNG string. If False, data are passed
    ...
    new_plotly.graph_objects.Image : image trace
    new_plotly.graph_objects.Heatmap : heatmap trace
