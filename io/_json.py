...
def to_json_plotly(plotly_object, pretty=False, engine=None):
    """
    Convert a new_plotly/Dash object to a JSON string representation

    Parameters
    ----------
    plotly_object:
        A new_plotly/Dash object represented as a dict, graph_object, or Dash component
    ...
    engine: str (default None)
        ...
        new_plotly.io.json.config.default_engine.
    ...
    See Also
    --------
    to_json : Convert a new_plotly Figure to JSON with validation
    """
...
def to_json(fig, validate=True, pretty=False, remove_uids=True, engine=None):
    ...
    See Also
    --------
    to_json_plotly : Convert an arbitrary new_plotly graph_object or Dash component to JSON
    """
    # Validate figure
    # ---------------
...
def from_json_plotly(value, engine=None):
    ...
    See Also
    --------
    from_json_plotly : Parse JSON with new_plotly conventions into a dict
    """
    orjson = get_module("orjson", should_load=True)
