        ...
        for template_name in template_names:
            ...
            if template is Lazy:
                ...
                if template_name == "none":
                    ...
                    template_str = pkgutil.get_data("new_plotly", path).decode("utf-8")
...
def walk_push_to_template(fig_obj, template_obj, skip):
    ...
    Parameters
    ----------
    fig_obj: new_plotly.basedatatypes.BasePlotlyType
    template_obj: new_plotly.basedatatypes.BasePlotlyType
    skip: set of str
