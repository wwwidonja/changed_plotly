...
class ViolinValidator(_plotly_utils.basevalidators.CompoundValidator):
    def __init__(self, plotly_name="violin", parent_name="", **kwargs):
        super(ViolinValidator, self).__init__(
            ...
            box
                :class:`new_plotly.graph_objects.violin.Box`
            ...
            line
                :class:`new_plotly.graph_objects.violin.Line`
                instance or dict with compatible properties
            marker
                :class:`new_plotly.graph_objects.violin.Marker`
                instance or dict with compatible properties
            meanline
                :class:`new_plotly.graph_objects.violin.Meanline`
                instance or dict with compatible properties
            meta
            ...
            selected
                :class:`new_plotly.graph_objects.violin.Selected`
                instance or dict with compatible properties
            selectedpoints
            ...
            spanmode
                ...
                `span` attribute.
            stream
                :class:`new_plotly.graph_objects.violin.Stream`
                instance or dict with compatible properties
            text
