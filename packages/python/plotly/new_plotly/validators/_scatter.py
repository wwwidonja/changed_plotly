    ...
    def __init__(self, plotly_name="scatter", parent_name="", **kwargs):
        super(ScatterValidator, self).__init__(
            ...
            dy
                ...
                info.
            error_x
                :class:`new_plotly.graph_objects.scatter.ErrorX`
                instance or dict with compatible properties
            error_y
                :class:`new_plotly.graph_objects.scatter.ErrorY`
                instance or dict with compatible properties
            fill
            ...
            line
                :class:`new_plotly.graph_objects.scatter.Line`
                instance or dict with compatible properties
            marker
                :class:`new_plotly.graph_objects.scatter.Marker`
                instance or dict with compatible properties
            meta
            ...
            orientation
                ...
                `fill`.
            selected
                :class:`new_plotly.graph_objects.scatter.Selected`
                instance or dict with compatible properties
            selectedpoints
            ...
            stream
                :class:`new_plotly.graph_objects.scatter.Stream`
                instance or dict with compatible properties
            text
