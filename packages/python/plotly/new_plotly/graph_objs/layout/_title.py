...
class Title(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.title.Font
        """
        return self["font"]
    ...
    def pad(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.title.Pad`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.title.Pad
        """
        return self["pad"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Title 
