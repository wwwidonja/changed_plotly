...
class Grid(_BaseLayoutHierarchyType):
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.grid.Domain`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.grid.Domain
        """
        return self["domain"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Grid 
