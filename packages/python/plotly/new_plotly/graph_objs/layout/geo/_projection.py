...
class Projection(_BaseLayoutHierarchyType):
    ...
    def rotation(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.projection.Rotation`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.projection.Rotation
        """
    ...
    def _prop_descriptions(self):
        ...
        rotation
            :class:`new_plotly.graph_objects.layout.geo.projection.Rota
    ...
    def __init__(
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.geo.Projection`
        parallels
            For conic projection types only. Sets the parallels
            (tangent, secant) where the cone intersects the sphere.
        rotation
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.geo.Projection 
