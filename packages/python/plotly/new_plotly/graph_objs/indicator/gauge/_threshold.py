...
class Threshold(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.threshold.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.threshold.Line
        """
        return self["line"]
    ...
    def __init__(self, arg=None, line=None, thickness=None, value=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.indicator.gauge.Threshold`
        line
            :class:`new_plotly.graph_objects.indicator.gauge.threshold.
            Line` instance or dict with compatible properties
        thickness
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.indicator.gauge.Threshold 
