...
def create_choropleth(
    ...
    **layout_options
    ...
    if not _plotly_geo:
        raise ValueError(
            """
The create_choropleth figure factory requires the new_plotly-geo package.
Install using pip with:

$ pip install new_plotly-geo

Or, install using conda with

$ conda install -c new_plotly new_plotly-geo
"""
        )
