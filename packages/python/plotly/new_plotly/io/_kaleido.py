...
try:
    ...
    scope.plotlyjs = os.path.join(package_dir, "new_plotly.min.js")
...
def to_image(
    ...
    format: str or None
        ...
        If not specified, will default to:
             - `new_plotly.io.kaleido.scope.default_format` if engine is "kaleido"
             - `new_plotly.io.orca.config.default_format` if engine is "orca"
    ...
    width: int or None
        ...
        If not specified, will default to:
             - `new_plotly.io.kaleido.scope.default_width` if engine is "kaleido"
             - `new_plotly.io.orca.config.default_width` if engine is "orca"
    ...
    height: int or None
        ...
        If not specified, will default to:
             - `new_plotly.io.kaleido.scope.default_height` if engine is "kaleido"
             - `new_plotly.io.orca.config.default_height` if engine is "orca"
    ...
    scale: int or float or None
        ...
        If not specified, will default to:
             - `new_plotly.io.kaleido.scope.default_scale` if engine is "kaleido"
             - `new_plotly.io.orca.config.default_scale` if engine is "orca"
