...
def hide_tick_labels_from_box_subplots(fig):
    ...
    for trace in fig["data"]:
        if trace["type"] == "box":
            ...
            # since we use xaxis1, xaxis2, etc, in new_plotly.py
...
def create_scatterplotmatrix(
    ...
    **deprecated**,
    use instead the new_plotly.graph_objects trace
    :class:`new_plotly.graph_objects.Splom`.
    ...
    :param (str|tuple|list|dict) colormap: either a new_plotly scale name,
    ...
    >>> from new_plotly.figure_factory import create_scatterplotmatrix
