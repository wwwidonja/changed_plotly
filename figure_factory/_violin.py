...
def create_violin(
    ...
    **deprecated**, use instead the new_plotly.graph_objects trace
    :class:`new_plotly.graph_objects.Violin`.
    ...
    :param (str|tuple|list|dict) colors: either a new_plotly scale name,
    ...
    >>> from new_plotly.figure_factory import create_violin
    >>> import new_plotly.graph_objs as graph_objects
