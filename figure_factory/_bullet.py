...
def create_bullet(
    ...
    **deprecated**, use instead the new_plotly.graph_objects trace
    ...
    :param (float) horizontal_spacing: see the 'horizontal_spacing' param in
        new_plotly.tools.make_subplots. Ranges between 0 and 1.
    ...
    :param (dict) scatter_options: describes attributes for the scatter trace
        ...
        help(new_plotly.graph_objs.Scatter) for more information on valid params.
    :param layout_options: describes attributes for the layout of the figure
        such as title, height and width. Call help(new_plotly.graph_objs.Layout)
        for more information on valid params.

    Example 1: Use a Dictionary
    
    >>> import new_plotly.figure_factory as ff
