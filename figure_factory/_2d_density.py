...
def create_2d_density(
    ...
    **deprecated**, use instead
    :func:`new_plotly.express.density_heatmap`.

    :param (list|array) x: x-axis data for plot generation
    :param (list|array) y: y-axis data for plot generation
    :param (str|tuple|list) colorscale: either a new_plotly scale name, an rgb
    ...
    >>> from new_plotly.figure_factory import create_2d_density
    >>> import numpy as np
