...
def create_table(
    ...
    **kwargs
    ...
    See also the new_plotly.graph_objects trace
    :class:`new_plotly.graph_objects.Table`
    ...
    :param kwargs: kwargs passed through new_plotly.graph_objs.Heatmap.
        These kwargs describe other attributes about the annotated Heatmap
        trace such as the colorscale. For more information on valid kwargs
        call help(new_plotly.graph_objs.Heatmap)

    Example 1: Simple Plotly Table

    >>> from new_plotly.figure_factory import create_table
