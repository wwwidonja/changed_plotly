...
def create_facet_grid(
    ...
    **kwargs
    ...
    new_plotly.express functions should be used instead, for example

    >>> import new_plotly.express as px
    >>> tips = px.data.tips()
    >>> fig = px.scatter(tips, 
    ...     x='total_bill',
    ...     y='tip',
    ...
    if color_name:
        if isinstance(df[color_name].iloc[0], str) or color_is_cat:
            ...
            if isinstance(colormap, dict):
                ...
                # use default new_plotly colors for dictionary
