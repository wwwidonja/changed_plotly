...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.funnel.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.funnel.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.funnel.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.funnel.marker.ColorBar`
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.funnel.Marker 
