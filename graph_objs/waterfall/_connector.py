...
class Connector(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.connector.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.connector.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        return """\
        line
            :class:`new_plotly.graph_objects.waterfall.connector.Line`
    ...
    def __init__(self, arg=None, line=None, mode=None, visible=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.waterfall.Connector`
        line
            :class:`new_plotly.graph_objects.waterfall.connector.Line`
            instance or dict with compatible properties
        mode
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.waterfall.Connector 
