...
class Z(_BaseTraceHierarchyType):
    ...
    def project(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.contours.z.Project`
        ...
        Returns
        -------
        new_plotly.graph_objs.surface.contours.z.Project
        """
        return self["project"]
    ...
    def _prop_descriptions(self):
        ...
        highlightwidth
            Sets the width of the highlighted contour lines.
        project
            :class:`new_plotly.graph_objects.surface.contours.z.Project
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.surface.contours.Z`
        color
            Sets the color of the contour lines.
        end
            Sets the end contour level value. Must be more than
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.surface.contours.Z 
