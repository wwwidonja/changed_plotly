...
class Scattermapbox(_BaseTraceType):
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Hoverlabel`
        ...
        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Line
        """
        return self["line"]
    ...
    def marker(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Marker
        """
        return self["marker"]
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Selected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.scattermapbox.sele
                    cted.Marker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Stream
        """
        return self["stream"]
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Textfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Textfont
        """
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattermapbox.Unselected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.scattermapbox.unse
                    lected.Marker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.scattermapbox.Unselected
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Scattermapbox`
        below
            Determines if this scattermapbox trace's layers are to
            be inserted before the layer with the specified ID. By
            default, scattermapbox layers are inserted above all
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Scattermapbox 
