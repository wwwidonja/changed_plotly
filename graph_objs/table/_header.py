...
class Header(_BaseTraceHierarchyType):
    ...
    def fill(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.header.Fill`
        ...
        Returns
        -------
        new_plotly.graph_objs.table.header.Fill
        """
        return self["fill"]
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.header.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.header.Font
        """
        return self["font"]
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.header.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.header.Line
        """
        return self["line"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.table.Header 
