...
class Cells(_BaseTraceHierarchyType):
    ...
    def fill(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.cells.Fill`
        ...
        Returns
        -------
        new_plotly.graph_objs.table.cells.Fill
        """
        return self["fill"]
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.cells.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.cells.Font
        """
        return self["font"]
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.cells.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.cells.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        alignsrc
            ...
            align .
        fill
            :class:`new_plotly.graph_objects.table.cells.Fill` instance
            or dict with compatible properties
        font
            :class:`new_plotly.graph_objects.table.cells.Font` instance
            or dict with compatible properties
        format
        ...
        height
            The height of cells.
        line
            :class:`new_plotly.graph_objects.table.cells.Line` instance
            or dict with compatible properties
        prefix
            Prefix for cell values.
        prefixsrc
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.table.Cells 
