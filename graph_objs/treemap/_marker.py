...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.treemap.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.treemap.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.treemap.marker.Line
        """
        return self["line"]
    ...
    def pad(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.treemap.marker.Pad`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.treemap.marker.Pad
        """
        return self["pad"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.treemap.marker.ColorBar`
        ...
        depthfade
            ...
            color.
        line
            :class:`new_plotly.graph_objects.treemap.marker.Line`
            instance or dict with compatible properties
        pad
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.treemap.Marker`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `marker.colorscale`. Has an effect only if colorsis set
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.treemap.Marker 
