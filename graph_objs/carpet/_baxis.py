...
class Baxis(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.baxis.Tickfont`
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.baxis.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.carpet.baxis.Tickformatstop
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.carpet.baxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.baxis.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.baxis.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.baxis.Title
        """
        return self["title"]
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.baxis.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            A tuple of :class:`new_plotly.graph_objects.carpet.baxis.Ti
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.carpet.Baxis 
