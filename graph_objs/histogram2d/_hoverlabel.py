...
class Hoverlabel(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.hoverlabel.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2d.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.histogram2d.Hoverlabel`
        align
            Sets the horizontal alignment of the text content
            within hover label box. Has an effect only if the hover
            label text spans more two or more lines
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.histogram2d.Hoverlabel 
