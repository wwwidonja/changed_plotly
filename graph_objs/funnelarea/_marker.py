...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.funnelarea.marker.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.funnelarea.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorssrc
            ...
            colors .
        line
            :class:`new_plotly.graph_objects.funnelarea.marker.Line`
    ...
    def __init__(self, arg=None, colors=None, colorssrc=None, line=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.funnelarea.Marker`
        colors
            Sets the color of each sector. If not specified, the
            default trace color set is used to pick the sector
            colors.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.funnelarea.Marker 
