...
class Title(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.funnelarea.title.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.funnelarea.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, position=None, text=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.funnelarea.Title`
        font
            Sets the font used for `title`. Note that the title's
            font used to be set by the now deprecated `titlefont`
            attribute.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.funnelarea.Title 
