...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickformatstops
                    A tuple of :class:`new_plotly.graph_objects.splom.m
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.splom.marker.ColorBar`
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.splom.Marker 
