...
class Dimension(_BaseTraceHierarchyType):
    ...
    def axis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.dimension.Axis`
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.dimension.Axis
        """
        return self["axis"]
    ...
    def _prop_descriptions(self):
        return """\
        axis
            :class:`new_plotly.graph_objects.splom.dimension.Axis`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.splom.Dimension`
        axis
            :class:`new_plotly.graph_objects.splom.dimension.Axis`
            instance or dict with compatible properties
        label
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.splom.Dimension 
