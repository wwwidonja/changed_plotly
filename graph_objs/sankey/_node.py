...
class Node(_BaseTraceHierarchyType):
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.node.Hoverlabel`
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.node.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.node.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.node.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        hoverlabel
            :class:`new_plotly.graph_objects.sankey.node.Hoverlabel`
        ...
        labelsrc
            ...
            label .
        line
            :class:`new_plotly.graph_objects.sankey.node.Line` instance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.sankey.Node 
