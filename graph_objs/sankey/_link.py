...
class Link(_BaseTraceHierarchyType):
    ...
    def colorscales(self):
        ...
        Colorscale that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.sankey.link.Colorscale
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.sankey.link.Colorscale]
        """
    ...
    def colorscaledefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.link.Colorscale`
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.link.Colorscale
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.link.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.link.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.link.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.link.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorscales
            A tuple of
            :class:`new_plotly.graph_objects.sankey.link.Colorscale`
        ...
        hoverlabel
            :class:`new_plotly.graph_objects.sankey.link.Hoverlabel`
        ...
        labelsrc
            ...
            label .
        line
            :class:`new_plotly.graph_objects.sankey.link.Line` instance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.sankey.Link 
