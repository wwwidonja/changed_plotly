...
class Caps(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.caps.X`
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.caps.X
        """
        return self["x"]
    ...
    def y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.caps.Y`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.caps.Y
        """
        return self["y"]
    ...
    def z(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.caps.Z`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.caps.Z
        """
        return self["z"]
    ...
    def _prop_descriptions(self):
        return """\
        x
            :class:`new_plotly.graph_objects.volume.caps.X` instance or
            dict with compatible properties
        y
            :class:`new_plotly.graph_objects.volume.caps.Y` instance or
            dict with compatible properties
        z
            :class:`new_plotly.graph_objects.volume.caps.Z` instance or
            dict with compatible properties
        """
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.volume.Caps 
