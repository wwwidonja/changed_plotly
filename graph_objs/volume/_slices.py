...
class Slices(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.slices.X`
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.slices.X
        """
        return self["x"]
    ...
    def y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.slices.Y`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.slices.Y
        """
        return self["y"]
    ...
    def z(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.slices.Z`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.slices.Z
        """
        return self["z"]
    ...
    def _prop_descriptions(self):
        return """\
        x
            :class:`new_plotly.graph_objects.volume.slices.X` instance
            or dict with compatible properties
        y
            :class:`new_plotly.graph_objects.volume.slices.Y` instance
            or dict with compatible properties
        z
            :class:`new_plotly.graph_objects.volume.slices.Z` instance
            or dict with compatible properties
        """
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.volume.Slices 
