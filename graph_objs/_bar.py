...
class Bar(_BaseTraceType):
    ...
    def error_x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.ErrorX`
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.ErrorX
        """
        return self["error_x"]
    ...
    def error_y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.ErrorY`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.ErrorY
        """
        return self["error_y"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Hoverlabel
        """
    ...
    def insidetextfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Insidetextfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Insidetextfont
        """
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Marker`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                colorsrc
                    ...
                    for  color .
                line
                    :class:`new_plotly.graph_objects.bar.marker.Line`
                ...
                opacitysrc
                    ...
                    for  opacity .
                pattern
                    :class:`new_plotly.graph_objects.bar.marker.Pattern
                    ` instance or dict with compatible properties
                reversescale
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Marker
        """
        return self["marker"]
    ...
    def outsidetextfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Outsidetextfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Outsidetextfont
        """
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Selected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.bar.selected.Marke
                    r` instance or dict with compatible properties
                textfont
                    :class:`new_plotly.graph_objects.bar.selected.Textf
                    ont` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.bar.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Stream
        """
        return self["stream"]
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Textfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.Textfont
        """
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.Unselected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.bar.unselected.Mar
                    ker` instance or dict with compatible
                    properties
                textfont
                    :class:`new_plotly.graph_objects.bar.unselected.Tex
                    tfont` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.bar.Unselected
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Bar`
        alignmentgroup
            Set several traces linked to the same position axis or
            matching axes to the same alignmentgroup. This controls
            whether bars compute their positional range dependently
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Bar 
