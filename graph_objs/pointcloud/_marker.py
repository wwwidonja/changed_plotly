...
class Marker(_BaseTraceHierarchyType):
    ...
    def border(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.pointcloud.marker.Border`
        ...
        Returns
        -------
        new_plotly.graph_objs.pointcloud.marker.Border
        """
        return self["border"]
    ...
    def _prop_descriptions(self):
        ...
        border
            :class:`new_plotly.graph_objects.pointcloud.marker.Border`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.pointcloud.Marker`
        blend
            Determines if colors are blended together for a
            translucency effect in case `opacity` is specified as a
            value less then `1`. Setting `blend` to `true` reduces
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.pointcloud.Marker 
