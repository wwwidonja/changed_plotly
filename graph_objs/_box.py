...
class Box(_BaseTraceType):
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Hoverlabel`
        ...
        Returns
        -------
        new_plotly.graph_objs.box.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.box.Line
        """
        return self["line"]
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Marker`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                line
                    :class:`new_plotly.graph_objects.box.marker.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.box.Marker
        """
        return self["marker"]
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Selected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.box.selected.Marke
                    r` instance or dict with compatible properties

        Returns
        -------
        new_plotly.graph_objs.box.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.box.Stream
        """
        return self["stream"]
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.Unselected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.box.unselected.Mar
                    ker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.box.Unselected
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Box`
        alignmentgroup
            Set several traces linked to the same position axis or
            matching axes to the same alignmentgroup. This controls
            whether bars compute their positional range dependently
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Box 
