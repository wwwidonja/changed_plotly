...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.box.marker.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.box.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        color
            ...
            set.
        line
            :class:`new_plotly.graph_objects.box.marker.Line` instance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.box.Marker 
