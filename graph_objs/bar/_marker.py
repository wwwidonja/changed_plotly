...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.marker.Line
        """
        return self["line"]
    ...
    def pattern(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.bar.marker.Pattern`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.bar.marker.Pattern
        """
        return self["pattern"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.bar.marker.ColorBar`
        ...
        colorsrc
            ...
            color .
        line
            :class:`new_plotly.graph_objects.bar.marker.Line` instance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.bar.Marker 
