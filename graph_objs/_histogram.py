...
class Histogram(_BaseTraceType):
    ...
    def cumulative(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Cumulative`
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Cumulative
        """
    ...
    def error_x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.ErrorX`
          - A dict of string/value properties that will be passed
    ...
    def error_y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.ErrorY`
          - A dict of string/value properties that will be passed
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Hoverlabel
        """
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Marker`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                coloraxis
                    ...
                    axis.
                colorbar
                    :class:`new_plotly.graph_objects.histogram.marker.C
                ...
                colorsrc
                    ...
                    for  color .
                line
                    :class:`new_plotly.graph_objects.histogram.marker.L
                ...
                opacitysrc
                    ...
                    for  opacity .
                pattern
                    :class:`new_plotly.graph_objects.histogram.marker.P
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Marker
        """
        return self["marker"]
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Selected`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Stream
        """
        return self["stream"]
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.Unselected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.histogram.unselect
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram.Unselected
        """
    ...
    def xbins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.XBins`
          - A dict of string/value properties that will be passed
    ...
    def ybins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram.YBins`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Histogram`
        alignmentgroup
            Set several traces linked to the same position axis or
            matching axes to the same alignmentgroup. This controls
            whether bars compute their positional range dependently
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Histogram 
