...
class Heatmap(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                title
                    :class:`new_plotly.graph_objects.heatmap.colorbar.T
        ...
        Returns
        -------
        new_plotly.graph_objs.heatmap.ColorBar
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.heatmap.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.heatmap.Hoverlabel
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.heatmap.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.heatmap.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Heatmap`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `colorscale`. In case `colorscale` is unspecified or
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Heatmap 
