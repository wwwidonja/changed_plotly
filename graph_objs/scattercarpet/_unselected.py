...
class Unselected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.scattercarpet.unselected.Marker
        """
        return self["marker"]
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scattercarpet.unselected.Textfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scattercarpet.unselected.Textfont
        """
    ...
    def _prop_descriptions(self):
        return """\
        marker
            :class:`new_plotly.graph_objects.scattercarpet.unselected.M
            arker` instance or dict with compatible properties
        textfont
            :class:`new_plotly.graph_objects.scattercarpet.unselected.T
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.scattercarpet.Unselected`
        marker
            :class:`new_plotly.graph_objects.scattercarpet.unselected.M
            arker` instance or dict with compatible properties
        textfont
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.scattercarpet.Unselected 
