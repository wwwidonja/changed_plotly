...
class Volume(_BaseTraceType):
    ...
    def caps(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Caps`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                x
                    :class:`new_plotly.graph_objects.volume.caps.X`
                    instance or dict with compatible properties
                y
                    :class:`new_plotly.graph_objects.volume.caps.Y`
                    instance or dict with compatible properties
                z
                    :class:`new_plotly.graph_objects.volume.caps.Z`
                    instance or dict with compatible properties

        Returns
        -------
        new_plotly.graph_objs.volume.Caps
        """
        return self["caps"]
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.ColorBar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                title
                    :class:`new_plotly.graph_objects.volume.colorbar.Ti
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.ColorBar
        """
    ...
    def contour(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Contour`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Contour
        """
        return self["contour"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Hoverlabel
        """
    ...
    def lighting(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Lighting`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Lighting
        """
    ...
    def lightposition(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Lightposition`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Lightposition
        """
    ...
    def slices(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Slices`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                x
                    :class:`new_plotly.graph_objects.volume.slices.X`
                    instance or dict with compatible properties
                y
                    :class:`new_plotly.graph_objects.volume.slices.Y`
                    instance or dict with compatible properties
                z
                    :class:`new_plotly.graph_objects.volume.slices.Z`
                    instance or dict with compatible properties

        Returns
        -------
        new_plotly.graph_objs.volume.Slices
        """
        return self["slices"]
    ...
    def spaceframe(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Spaceframe`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Spaceframe
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Stream
        """
        return self["stream"]
    ...
    def surface(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.volume.Surface`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.volume.Surface
        """
        return self["surface"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Volume`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `colorscale`. In case `colorscale` is unspecified or
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Volume 
