...
class Caps(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.isosurface.caps.X`
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.caps.X
        """
        return self["x"]
    ...
    def y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.isosurface.caps.Y`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.caps.Y
        """
        return self["y"]
    ...
    def z(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.caps.Z
        """
        return self["z"]
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.isosurface.Caps`
        x
            :class:`new_plotly.graph_objects.isosurface.caps.X`
            instance or dict with compatible properties
        y
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.isosurface.Caps 
