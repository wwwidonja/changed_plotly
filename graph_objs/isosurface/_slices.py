...
class Slices(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.isosurface.slices.X`
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.slices.X
        """
        return self["x"]
    ...
    def y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.isosurface.slices.Y`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.slices.Y
        """
        return self["y"]
    ...
    def z(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.isosurface.slices.Z`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.isosurface.slices.Z
        """
        return self["z"]
    ...
    def _prop_descriptions(self):
        return """\
        x
            :class:`new_plotly.graph_objects.isosurface.slices.X`
            instance or dict with compatible properties
        y
            :class:`new_plotly.graph_objects.isosurface.slices.Y`
            instance or dict with compatible properties
        z
            :class:`new_plotly.graph_objects.isosurface.slices.Z`
            instance or dict with compatible properties
        """
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.isosurface.Slices`
        x
            :class:`new_plotly.graph_objects.isosurface.slices.X`
            instance or dict with compatible properties
        y
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.isosurface.Slices 
