...
class Indicator(_BaseTraceType):
    ...
    def delta(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Delta`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                decreasing
                    :class:`new_plotly.graph_objects.indicator.delta.De
                    creasing` instance or dict with compatible
                    properties
                font
                    Set the font used to display the delta
                increasing
                    :class:`new_plotly.graph_objects.indicator.delta.In
                    creasing` instance or dict with compatible
                    properties
                position
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.Delta
        """
        return self["delta"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.Domain
        """
        return self["domain"]
    ...
    def gauge(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Gauge`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                axis
                    :class:`new_plotly.graph_objects.indicator.gauge.Ax
                ...
                steps
                    A tuple of :class:`new_plotly.graph_objects.indicat
                ...
                threshold
                    :class:`new_plotly.graph_objects.indicator.gauge.Th
                    reshold` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.indicator.Gauge
        """
        return self["gauge"]
    ...
    def number(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Number`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.Number
        """
        return self["number"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.Stream
        """
        return self["stream"]
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.Title
        """
        return self["title"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Indicator`
        align
            Sets the horizontal alignment of the `text` within the
            box. Note that this attribute has no effect if an
            angular gauge is displayed: in this case, it is always
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Indicator 
