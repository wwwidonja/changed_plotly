...
class Hoverlabel(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.hoverlabel.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.histogram2dcontour.Hoverlabel 
