...
class Sankey(_BaseTraceType):
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Domain`
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Domain
        """
        return self["domain"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Hoverlabel
        """
    ...
    def link(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Link`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                hoverinfo
                    ...
                    fired.
                hoverlabel
                    :class:`new_plotly.graph_objects.sankey.link.Hoverl
                ...
                labelsrc
                    ...
                    for  label .
                line
                    :class:`new_plotly.graph_objects.sankey.link.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Link
        """
        return self["link"]
    ...
    def node(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Node`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                hoverinfo
                    ...
                    fired.
                hoverlabel
                    :class:`new_plotly.graph_objects.sankey.node.Hoverl
                    abel` instance or dict with compatible
                    properties
                hovertemplate
                    Template string used for rendering the
                ...
                labelsrc
                    ...
                    for  label .
                line
                    :class:`new_plotly.graph_objects.sankey.node.Line`
                    instance or dict with compatible properties
                pad
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Node
        """
        return self["node"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Stream
        """
        return self["stream"]
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.sankey.Textfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.sankey.Textfont
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Sankey`
        arrangement
            If value is `snap` (the default), the node arrangement
            is assisted by automatic snapping of elements to
            preserve space between nodes specified via `nodepad`.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Sankey 
