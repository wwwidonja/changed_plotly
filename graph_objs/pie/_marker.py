...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.pie.marker.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.pie.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorssrc
            ...
            colors .
        line
            :class:`new_plotly.graph_objects.pie.marker.Line` instance
    ...
    def __init__(self, arg=None, colors=None, colorssrc=None, line=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.pie.Marker 
