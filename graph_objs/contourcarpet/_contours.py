...
class Contours(_BaseTraceHierarchyType):
    ...
    def labelfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.contourcarpet.contours.Labelfont`
        ...
        Returns
        -------
        new_plotly.graph_objs.contourcarpet.contours.Labelfont
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.contourcarpet.Contours`
        coloring
            Determines the coloring method showing the contour
            values. If "fill", coloring is done evenly between each
            contour level If "lines", coloring is done on the
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.contourcarpet.Contours 
