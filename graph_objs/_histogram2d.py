...
class Histogram2d(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.ColorBar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                title
                    :class:`new_plotly.graph_objects.histogram2d.colorb
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2d.ColorBar
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2d.Hoverlabel
        """
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.Marker`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2d.Marker
        """
        return self["marker"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2d.Stream
        """
        return self["stream"]
    ...
    def xbins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.XBins`
          - A dict of string/value properties that will be passed
    ...
    def ybins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2d.YBins`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Histogram2d`
        autobinx
            Obsolete: since v1.42 each bin attribute is auto-
            determined separately and `autobinx` is not needed.
            However, we accept `autobinx: true` or `false` and will
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Histogram2d 
