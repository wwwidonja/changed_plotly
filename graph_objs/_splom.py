...
class Splom(_BaseTraceType):
    ...
    def diagonal(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Diagonal`
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Diagonal
        """
    ...
    def dimensions(self):
        ...
        Dimension that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.splom.Dimension
          - A list or tuple of dicts of string/value properties that
            ...
            Supported dict properties:
                ...
                axis
                    :class:`new_plotly.graph_objects.splom.dimension.Ax
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.splom.Dimension]
        """
    ...
    def dimensiondefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Dimension`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Dimension
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Hoverlabel
        """
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Marker`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Marker
        """
        return self["marker"]
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Selected`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.splom.Stream
        """
        return self["stream"]
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.splom.Unselected`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.splom.unselected.M
                    arker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.splom.Unselected
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Splom`
        customdata
            Assigns extra data each datum. This may be useful when
            listening to hover, click and selection events. Note
            that, "scatter" traces also appends customdata items in
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Splom 
