...
class Marker(_BaseTraceHierarchyType):
    ...
    def gradient(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.marker.Gradient`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.marker.Gradient
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.scatter.marker.ColorBar`
        ...
        colorsrc
            ...
            color .
        gradient
            :class:`new_plotly.graph_objects.scatter.marker.Gradient`
            instance or dict with compatible properties
        line
            :class:`new_plotly.graph_objects.scatter.marker.Line`
            instance or dict with compatible properties
        maxdisplayed
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.scatter.Marker`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `marker.colorscale`. Has an effect only if in
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.scatter.Marker 
