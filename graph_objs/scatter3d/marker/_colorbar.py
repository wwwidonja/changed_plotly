...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter3d.marker.colorbar.Tickfont`
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter3d.marker.colorbar.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.scatter3d.marker.colorbar.Tickformatstop
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.scatter3d.marker.colorbar.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter3d.marker.colorbar.Tickformatstop`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter3d.marker.colorbar.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter3d.marker.colorbar.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter3d.marker.colorbar.Title
        """
        return self["title"]
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter3d.marker.colorbar.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            A tuple of :class:`new_plotly.graph_objects.scatter3d.marke
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :class:`new_plotly.graph_objects.scatter3d.marker.colorbar.
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.scatter3d.marker.ColorBar`
        bgcolor
            Sets the color of padded area.
        bordercolor
            Sets the axis line color.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.scatter3d.marker.ColorBar 
constructor must be a dict or 
an instance of :class:`new_plotly.graph_objs.scatter3d.marker.ColorBar`"""
            )
