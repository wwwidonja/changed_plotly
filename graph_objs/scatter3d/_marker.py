...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter3d.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter3d.marker.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter3d.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorsrc
            ...
            color .
        line
            :class:`new_plotly.graph_objects.scatter3d.marker.Line`
            instance or dict with compatible properties
        opacity
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.scatter3d.Marker`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `marker.colorscale`. Has an effect only if in
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.scatter3d.Marker 
