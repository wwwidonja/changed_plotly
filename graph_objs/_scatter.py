...
class Scatter(_BaseTraceType):
    ...
    def error_x(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.ErrorX`
    ...
    def error_y(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.ErrorY`
          - A dict of string/value properties that will be passed
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Line`
          - A dict of string/value properties that will be passed
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Marker`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                coloraxis
                    ...
                    axis.
                colorbar
                    :class:`new_plotly.graph_objects.scatter.marker.Col
                ...
                colorsrc
                    ...
                    for  color .
                gradient
                    :class:`new_plotly.graph_objects.scatter.marker.Gra
                    dient` instance or dict with compatible
                    properties
                line
                    :class:`new_plotly.graph_objects.scatter.marker.Lin
    ...
    def selected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Selected`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.Selected
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Stream`
          - A dict of string/value properties that will be passed
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Textfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.Textfont
        """
    ...
    def unselected(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.scatter.Unselected`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.scatter.Unselected
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Scatter`
        cliponaxis
            Determines whether or not markers and text nodes are
            clipped about the subplot axes. To show markers and
            text nodes above axis lines and tick labels, make sure
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Scatter 
