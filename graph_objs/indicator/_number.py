...
class Number(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.number.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.number.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.indicator.Number`
        font
            Set the font used to display main number
        prefix
            Sets a prefix appearing before the number.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.indicator.Number 
