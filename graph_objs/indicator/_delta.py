...
class Delta(_BaseTraceHierarchyType):
    ...
    def decreasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.delta.Decreasing`
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.delta.Decreasing
        """
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.delta.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.delta.Font
        """
        return self["font"]
    ...
    def increasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.delta.Increasing`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.delta.Increasing
        """
    ...
    def _prop_descriptions(self):
        return """\
        decreasing
            :class:`new_plotly.graph_objects.indicator.delta.Decreasing
            ` instance or dict with compatible properties
        font
            Set the font used to display the delta
        increasing
            :class:`new_plotly.graph_objects.indicator.delta.Increasing
            ` instance or dict with compatible properties
        position
            Sets the position of delta with respect to the number.
        reference
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.indicator.Delta`
        decreasing
            :class:`new_plotly.graph_objects.indicator.delta.Decreasing
            ` instance or dict with compatible properties
        font
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.indicator.Delta 
