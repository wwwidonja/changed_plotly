...
class Step(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.step.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.step.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        color
            Sets the background color of the arc.
        line
            :class:`new_plotly.graph_objects.indicator.gauge.step.Line`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.indicator.gauge.Step`
        color
            Sets the background color of the arc.
        line
            :class:`new_plotly.graph_objects.indicator.gauge.step.Line`
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.indicator.gauge.Step 
