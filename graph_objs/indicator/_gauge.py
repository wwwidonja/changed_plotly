...
class Gauge(_BaseTraceHierarchyType):
    ...
    def axis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.Axis`
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.Axis
        """
        return self["axis"]
    ...
    def bar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.Bar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                line
                    :class:`new_plotly.graph_objects.indicator.gauge.ba
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.Bar
        """
        return self["bar"]
    ...
    def steps(self):
        ...
        Step that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.indicator.gauge.Step
          - A list or tuple of dicts of string/value properties that
            ...
            Supported dict properties:
                ...
                color
                    Sets the background color of the arc.
                line
                    :class:`new_plotly.graph_objects.indicator.gauge.st
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.indicator.gauge.Step]
        """
        return self["steps"]
    ...
    def stepdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.Step`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.Step
        """
    ...
    def threshold(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.indicator.gauge.Threshold`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.indicator.gauge.Threshold
        """
    ...
    def _prop_descriptions(self):
        return """\
        axis
            :class:`new_plotly.graph_objects.indicator.gauge.Axis`
        ...
        steps
            A tuple of
            :class:`new_plotly.graph_objects.indicator.gauge.Step`
        ...
        stepdefaults
            ...
            indicator.gauge.steps
        threshold
            :class:`new_plotly.graph_objects.indicator.gauge.Threshold`
            instance or dict with compatible properties
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.indicator.Gauge`
        axis
            :class:`new_plotly.graph_objects.indicator.gauge.Axis`
            instance or dict with compatible properties
        bar
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.indicator.Gauge 
