...
class Histogram2dContour(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.ColorBar`
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.ColorBar
        """
    ...
    def contours(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.Contours`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.Contours
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.Hoverlabel
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.Line
        """
        return self["line"]
    ...
    def marker(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.Marker
        """
        return self["marker"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.Stream
        """
        return self["stream"]
    ...
    def xbins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.XBins`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.XBins
        """
        return self["xbins"]
    ...
    def ybins(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.histogram2dcontour.YBins`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.histogram2dcontour.YBins
        """
        return self["ybins"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.Histogram2dContour`
        autobinx
            Obsolete: since v1.42 each bin attribute is auto-
            determined separately and `autobinx` is not needed.
            However, we accept `autobinx: true` or `false` and will
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Histogram2dContour 
constructor must be a dict or 
an instance of :class:`new_plotly.graph_objs.Histogram2dContour`"""
            )
