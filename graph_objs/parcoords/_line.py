...
class Line(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickformatstops
                    A tuple of :class:`new_plotly.graph_objects.parcoor
        ...
        Returns
        -------
        new_plotly.graph_objs.parcoords.line.ColorBar
        """
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.parcoords.line.ColorBar`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.parcoords.Line`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `line.colorscale`. Has an effect only if in
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.parcoords.Line 
