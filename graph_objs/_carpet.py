...
class Carpet(_BaseTraceType):
    ...
    def aaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.Aaxis`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickvalssrc
                    ...
                    for  tickvals .
                title
                    :class:`new_plotly.graph_objects.carpet.aaxis.Title
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.Aaxis
        """
        return self["aaxis"]
    ...
    def baxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.Baxis`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickvalssrc
                    ...
                    for  tickvals .
                title
                    :class:`new_plotly.graph_objects.carpet.baxis.Title
                    ` instance or dict with compatible properties
                titlefont
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.Baxis
        """
        return self["baxis"]
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.Font
        """
        return self["font"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.carpet.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.carpet.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Carpet`
        a
            An array containing values of the first parameter value
        a0
            Alternate to `a`. Builds a linear space of a
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Carpet 
