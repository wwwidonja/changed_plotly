...
class Cone(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.cone.ColorBar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickformatstops
                    A tuple of :class:`new_plotly.graph_objects.cone.co
                ...
                title
                    :class:`new_plotly.graph_objects.cone.colorbar.Titl
        ...
        Returns
        -------
        new_plotly.graph_objs.cone.ColorBar
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.cone.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.cone.Hoverlabel
        """
    ...
    def lighting(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.cone.Lighting`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.cone.Lighting
        """
    ...
    def lightposition(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.cone.Lightposition`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.cone.Lightposition
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.cone.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.cone.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Cone`
        anchor
            Sets the cones' anchor with respect to their x/y/z
            positions. Note that "cm" denote the cone's center of
            mass which corresponds to 1/4 from the tail to tip.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Cone 
