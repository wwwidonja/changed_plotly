...
class Table(_BaseTraceType):
    ...
    def cells(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.Cells`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                alignsrc
                    ...
                    for  align .
                fill
                    :class:`new_plotly.graph_objects.table.cells.Fill`
                    instance or dict with compatible properties
                font
                    :class:`new_plotly.graph_objects.table.cells.Font`
                    instance or dict with compatible properties
                format
                ...
                height
                    The height of cells.
                line
                    :class:`new_plotly.graph_objects.table.cells.Line`
                    instance or dict with compatible properties
                prefix
        ...
        Returns
        -------
        new_plotly.graph_objs.table.Cells
        """
        return self["cells"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.Domain
        """
        return self["domain"]
    ...
    def header(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.Header`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                alignsrc
                    ...
                    for  align .
                fill
                    :class:`new_plotly.graph_objects.table.header.Fill`
                    instance or dict with compatible properties
                font
                    :class:`new_plotly.graph_objects.table.header.Font`
                    instance or dict with compatible properties
                format
                    Sets the cell value formatting rule using d3
                    formatting mini-language which is similar to
                ...
                height
                    The height of cells.
                line
                    :class:`new_plotly.graph_objects.table.header.Line`
                    instance or dict with compatible properties
                prefix
                    Prefix for cell values.
                prefixsrc
        ...
        Returns
        -------
        new_plotly.graph_objs.table.Header
        """
        return self["header"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.Hoverlabel
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.table.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.table.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Table`
        cells
            :class:`new_plotly.graph_objects.table.Cells` instance or
            dict with compatible properties
        columnorder
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Table 
