...
class Dimension(_BaseTraceHierarchyType):
    ...
    def categoryorder(self):
        ...
        dimension. By default, new_plotly uses "trace", which specifies the
    ...
    def _prop_descriptions(self):
        ...
        categoryorder
            Specifies the ordering logic for the categories in the
            dimension. By default, new_plotly uses "trace", which
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.parcats.Dimension`
        categoryarray
            Sets the order in which categories in this dimension
            appear. Only has an effect if `categoryorder` is set to
            "array". Used with `categoryorder`.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.parcats.Dimension 
