...
class Line(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.parcats.line.ColorBar
        """
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`new_plotly.graph_objects.parcats.line.ColorBar`
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.parcats.Line 
