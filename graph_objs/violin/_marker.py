...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.violin.marker.Line`
        ...
        Returns
        -------
        new_plotly.graph_objs.violin.marker.Line
        """
        return self["line"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.violin.Marker 
