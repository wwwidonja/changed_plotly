...
class Box(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.violin.box.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        fillcolor
            Sets the inner box plot fill color.
        line
            :class:`new_plotly.graph_objects.violin.box.Line` instance
    ...
    def __init__(
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.violin.Box 
