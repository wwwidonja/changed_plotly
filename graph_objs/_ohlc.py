...
class Ohlc(_BaseTraceType):
    ...
    def decreasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.ohlc.Decreasing`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                line
                    :class:`new_plotly.graph_objects.ohlc.decreasing.Li
                    ne` instance or dict with compatible properties

        Returns
        -------
        new_plotly.graph_objs.ohlc.Decreasing
        """
    ...
    def hoverlabel(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.ohlc.Hoverlabel
        """
    ...
    def increasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.ohlc.Increasing`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                line
                    :class:`new_plotly.graph_objects.ohlc.increasing.Li
                    ne` instance or dict with compatible properties

        Returns
        -------
        new_plotly.graph_objs.ohlc.Increasing
        """
    ...
    def line(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.ohlc.Line
        """
        return self["line"]
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.ohlc.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.ohlc.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Ohlc`
        close
            Sets the close values.
        closesrc
            Sets the source reference on Chart Studio Cloud for
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Ohlc 
