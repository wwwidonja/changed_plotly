...
class Scene(_BaseLayoutHierarchyType):
    ...
    def annotations(self):
        ...
        Annotation that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.scene.Annotation
          - A list or tuple of dicts of string/value properties that
            ...
            Supported dict properties:
                ...
                hoverlabel
                    :class:`new_plotly.graph_objects.layout.scene.annot
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.scene.Annotation]
        """
    ...
    def annotationdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.Annotation`
    ...
    def aspectratio(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.Aspectratio`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.Aspectratio
        """
    ...
    def camera(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.Camera`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.Camera
        """
        return self["camera"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.Domain
        """
        return self["domain"]
    ...
    def xaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.XAxis`
          - A dict of string/value properties that will be passed
    ...
    def yaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.YAxis`
          - A dict of string/value properties that will be passed
    ...
    def zaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.ZAxis`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        annotations
            A tuple of
            :class:`new_plotly.graph_objects.layout.scene.Annotation`
        ...
        camera
            :class:`new_plotly.graph_objects.layout.scene.Camera`
            instance or dict with compatible properties
        domain
            :class:`new_plotly.graph_objects.layout.scene.Domain`
            instance or dict with compatible properties
        dragmode
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Scene 
