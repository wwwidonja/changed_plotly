...
class Mapbox(_BaseLayoutHierarchyType):
    ...
    def center(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.Center`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.Center
        """
        return self["center"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.Domain
        """
        return self["domain"]
    ...
    def layers(self):
        ...
        Layer that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.mapbox.Layer
          - A list or tuple of dicts of string/value properties that
            ...
            Supported dict properties:
                ...
                circle
                    :class:`new_plotly.graph_objects.layout.mapbox.laye
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.mapbox.Layer]
        """
        return self["layers"]
    ...
    def layerdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.Layer`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.Layer
        """
    ...
    def style(self):
        ...
        js/style-spec  The built-in new_plotly.js styles objects are: open-
    ...
    def _prop_descriptions(self):
        ...
        center
            :class:`new_plotly.graph_objects.layout.mapbox.Center`
            instance or dict with compatible properties
        domain
            :class:`new_plotly.graph_objects.layout.mapbox.Domain`
            instance or dict with compatible properties
        layers
            A tuple of
            :class:`new_plotly.graph_objects.layout.mapbox.Layer`
        ...
        style
            ...
            built-in new_plotly.js styles objects are: open-street-map,
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Mapbox 
