...
class Currentvalue(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.currentvalue.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.currentvalue.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.slider.Currentvalue`
        font
            Sets the font of the current value label text.
        offset
            The amount of space, in pixels, between the current
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.slider.Currentvalue 
