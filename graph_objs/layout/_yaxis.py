...
class YAxis(_BaseLayoutHierarchyType):
    ...
    def rangebreaks(self):
        ...
        Rangebreak that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.yaxis.Rangebreak
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.yaxis.Rangebreak]
        """
    ...
    def rangebreakdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.yaxis.Rangebreak`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.yaxis.Rangebreak
        """
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.yaxis.Tickfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.yaxis.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.yaxis.Tickformatstop
          - A list or tuple of dicts of string/value properties that
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.yaxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.yaxis.Tickformatstop`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.yaxis.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.yaxis.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.yaxis.Title
        """
        return self["title"]
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.yaxis.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        rangebreaks
            A tuple of
            :class:`new_plotly.graph_objects.layout.yaxis.Rangebreak`
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            A tuple of :class:`new_plotly.graph_objects.layout.yaxis.Ti
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.YAxis 
