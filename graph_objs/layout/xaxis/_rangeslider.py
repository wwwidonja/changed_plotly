...
class Rangeslider(_BaseLayoutHierarchyType):
    ...
    def yaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.rangeslider.YAxis`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.rangeslider.YAxis
        """
        return self["yaxis"]
    ...
    def _prop_descriptions(self):
        ...
        visible
            ...
            `fixedrange`
        yaxis
            :class:`new_plotly.graph_objects.layout.xaxis.rangeslider.Y
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.xaxis.Rangeslider`
        autorange
            Determines whether or not the range slider range is
            computed in relation to the input data. If `range` is
            provided, then `autorange` is set to False.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.xaxis.Rangeslider 
