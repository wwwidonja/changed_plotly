...
class Rangeselector(_BaseLayoutHierarchyType):
    ...
    def buttons(self):
        ...
        Button that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.xaxis.rangeselector.Button
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.xaxis.rangeselector.Button]
        """
        return self["buttons"]
    ...
    def buttondefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.rangeselector.Button`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.rangeselector.Button
        """
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.rangeselector.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.rangeselector.Font
        """
        return self["font"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.xaxis.Rangeselector`
        activecolor
            Sets the background color of the active range selector
            button.
        bgcolor
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.xaxis.Rangeselector 
