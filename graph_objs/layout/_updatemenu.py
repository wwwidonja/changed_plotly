...
class Updatemenu(_BaseLayoutHierarchyType):
    ...
    def buttons(self):
        ...
        Button that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.updatemenu.Button
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.updatemenu.Button]
        """
        return self["buttons"]
    ...
    def buttondefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.updatemenu.Button`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.updatemenu.Button
        """
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.updatemenu.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.updatemenu.Font
        """
        return self["font"]
    ...
    def pad(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.updatemenu.Pad`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.updatemenu.Pad
        """
        return self["pad"]
    ...
    def _prop_descriptions(self):
        ...
        buttons
            A tuple of
            :class:`new_plotly.graph_objects.layout.updatemenu.Button`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.Updatemenu`
        active
            Determines which button (by index starting from 0) is
            considered active.
        bgcolor
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Updatemenu 
