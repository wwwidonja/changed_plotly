...
class Slider(_BaseLayoutHierarchyType):
    ...
    def currentvalue(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.Currentvalue`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.Currentvalue
        """
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.Font`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.Font
        """
        return self["font"]
    ...
    def pad(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.Pad`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.Pad
        """
        return self["pad"]
    ...
    def steps(self):
        ...
        Step that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.slider.Step
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.slider.Step]
        """
        return self["steps"]
    ...
    def stepdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.Step`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.Step
        """
    ...
    def transition(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.slider.Transition`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.slider.Transition
        """
    ...
    def _prop_descriptions(self):
        ...
        borderwidth
            ...
            slider.
        currentvalue
            :class:`new_plotly.graph_objects.layout.slider.Currentvalue
        ...
        steps
            A tuple of
            :class:`new_plotly.graph_objects.layout.slider.Step`
        ...
        tickwidth
            Sets the tick width (in px).
        transition
            :class:`new_plotly.graph_objects.layout.slider.Transition`
            instance or dict with compatible properties
        visible
            Determines whether or not the slider is visible.
        x
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Slider 
