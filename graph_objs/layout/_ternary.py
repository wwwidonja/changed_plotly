...
class Ternary(_BaseLayoutHierarchyType):
    ...
    def aaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.ternary.Aaxis`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.ternary.Aaxis
        """
        return self["aaxis"]
    ...
    def baxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.ternary.Baxis`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.ternary.Baxis
        """
        return self["baxis"]
    ...
    def caxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.ternary.Caxis`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.ternary.Caxis
        """
        return self["caxis"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.ternary.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.ternary.Domain
        """
        return self["domain"]
    ...
    def _prop_descriptions(self):
        return """\
        aaxis
            :class:`new_plotly.graph_objects.layout.ternary.Aaxis`
            instance or dict with compatible properties
        baxis
            :class:`new_plotly.graph_objects.layout.ternary.Baxis`
            instance or dict with compatible properties
        bgcolor
            Set the background color of the subplot
        caxis
            :class:`new_plotly.graph_objects.layout.ternary.Caxis`
            instance or dict with compatible properties
        domain
            :class:`new_plotly.graph_objects.layout.ternary.Domain`
            instance or dict with compatible properties
        sum
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.Ternary`
        aaxis
            :class:`new_plotly.graph_objects.layout.ternary.Aaxis`
            instance or dict with compatible properties
        baxis
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Ternary 
