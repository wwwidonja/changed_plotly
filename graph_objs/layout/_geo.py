...
class Geo(_BaseLayoutHierarchyType):
    ...
    def center(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.Center`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.Center
        """
        return self["center"]
    ...
    def domain(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.Domain`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.Domain
        """
        return self["domain"]
    ...
    def lataxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.Lataxis`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.Lataxis
        """
        return self["lataxis"]
    ...
    def lonaxis(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.Lonaxis`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.Lonaxis
        """
        return self["lonaxis"]
    ...
    def projection(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.geo.Projection`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.geo.Projection
        """
    ...
    def _prop_descriptions(self):
        ...
        oceancolor
            Sets the ocean color
        projection
            :class:`new_plotly.graph_objects.layout.geo.Projection`
            instance or dict with compatible properties
        resolution
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Geo 
