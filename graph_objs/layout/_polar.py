...
class Polar(_BaseLayoutHierarchyType):
    ...
    def domain(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.polar.Domain
        """
        return self["domain"]
    ...
    def _prop_descriptions(self):
        return """\
        angularaxis
            :class:`new_plotly.graph_objects.layout.polar.AngularAxis`
        ...
        bgcolor
            Set the background color of the subplot
        domain
            :class:`new_plotly.graph_objects.layout.polar.Domain`
            instance or dict with compatible properties
        gridshape
        ...
        hole
            ...
            subplot.
        radialaxis
            :class:`new_plotly.graph_objects.layout.polar.RadialAxis`
            instance or dict with compatible properties
        sector
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Polar 
