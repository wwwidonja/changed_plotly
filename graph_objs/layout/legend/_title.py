...
class Title(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.legend.title.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.legend.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.legend.Title`
        font
            Sets this legend's title font. Defaults to
            `legend.font` with its size increased about 20%.
        side
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.legend.Title 
