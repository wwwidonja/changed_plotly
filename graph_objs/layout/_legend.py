...
class Legend(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.legend.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.legend.Font
        """
        return self["font"]
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.legend.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.legend.Title
        """
        return self["title"]
    ...
    def _prop_descriptions(self):
        ...
        orientation
            Sets the orientation of the legend.
        title
            :class:`new_plotly.graph_objects.layout.legend.Title`
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.Legend 
