...
class Symbol(_BaseLayoutHierarchyType):
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.layer.symbol.Textfont`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.layer.symbol.Textfont
        """
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.mapbox.layer.Symbol`
        icon
            Sets the symbol icon image (mapbox.layer.layout.icon-
            image). Full list: https://www.mapbox.com/maki-icons/
        iconsize
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.mapbox.layer.Symbol 
