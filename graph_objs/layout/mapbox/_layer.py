...
class Layer(_BaseLayoutHierarchyType):
    ...
    def circle(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.layer.Circle`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.layer.Circle
        """
        return self["circle"]
    ...
    def fill(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.layer.Fill`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.layer.Fill
        """
        return self["fill"]
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.layer.Line`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.layer.Line
        """
        return self["line"]
    ...
    def symbol(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.mapbox.layer.Symbol`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.mapbox.layer.Symbol
        """
        return self["symbol"]
    ...
    def _prop_descriptions(self):
        ...
        circle
            :class:`new_plotly.graph_objects.layout.mapbox.layer.Circle
        ...
        coordinates
            ...
            `sourcetype`.
        fill
            :class:`new_plotly.graph_objects.layout.mapbox.layer.Fill`
            instance or dict with compatible properties
        line
            :class:`new_plotly.graph_objects.layout.mapbox.layer.Line`
            instance or dict with compatible properties
        maxzoom
        ...
        sourcetype
            ...
            of the layer data.
        symbol
            :class:`new_plotly.graph_objects.layout.mapbox.layer.Symbol
            ` instance or dict with compatible properties
        templateitemname
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.mapbox.Layer`
        below
            Determines if the layer will be inserted before the
            layer with the specified ID. If omitted or set to '',
            the layer will be inserted above every existing layer.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.mapbox.Layer 
