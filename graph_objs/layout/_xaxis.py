...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def rangebreaks(self):
        ...
        Rangebreak that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.xaxis.Rangebreak
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.xaxis.Rangebreak]
        """
    ...
    def rangebreakdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Rangebreak`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Rangebreak
        """
    ...
    def rangeselector(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Rangeselector`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Rangeselector
        """
    ...
    def rangeslider(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Rangeslider`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Rangeslider
        """
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Tickfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.xaxis.Tickformatstop
          - A list or tuple of dicts of string/value properties that
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.xaxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Tickformatstop`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.Title`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                standoff
                    ...
                    turning on `automargin`, new_plotly.js will push
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.xaxis.Title
        """
        return self["title"]
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.xaxis.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def type(self):
        """
        Sets the axis type. By default, new_plotly attempts to determined
    ...
    def _prop_descriptions(self):
        ...
        rangebreaks
            A tuple of
            :class:`new_plotly.graph_objects.layout.xaxis.Rangebreak`
        ...
        rangeselector
            :class:`new_plotly.graph_objects.layout.xaxis.Rangeselector
            ` instance or dict with compatible properties
        rangeslider
            :class:`new_plotly.graph_objects.layout.xaxis.Rangeslider`
            instance or dict with compatible properties
        scaleanchor
            If set to another axis id (e.g. `x2`, `y`), the range
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            A tuple of :class:`new_plotly.graph_objects.layout.xaxis.Ti
        ...
        titlefont
            ...
            attribute.
        type
            Sets the axis type. By default, new_plotly attempts to
    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.XAxis 
