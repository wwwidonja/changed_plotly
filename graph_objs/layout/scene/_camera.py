...
class Camera(_BaseLayoutHierarchyType):
    ...
    def center(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.camera.Center`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.camera.Center
        """
        return self["center"]
    ...
    def eye(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.camera.Eye`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.camera.Eye
        """
        return self["eye"]
    ...
    def projection(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.camera.Projection`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.camera.Projection
        """
    ...
    def up(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.camera.Up`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.camera.Up
        """
        return self["up"]
    ...
    def _prop_descriptions(self):
        ...
        eye
            ...
            of this scene.
        projection
            :class:`new_plotly.graph_objects.layout.scene.camera.Projec
    ...
    def __init__(
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.scene.Camera`
        center
            Sets the (x,y,z) components of the 'center' camera
            vector This vector determines the translation (x,y,z)
            space about the center of this scene. By default, there
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.scene.Camera 
