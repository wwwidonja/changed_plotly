...
class Title(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.yaxis.title.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, font=None, text=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.scene.yaxis.Title`
        font
            Sets this axis' title font. Note that the title's font
            used to be customized by the now deprecated `titlefont`
            attribute.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.scene.yaxis.Title 
