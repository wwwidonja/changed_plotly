...
class Annotation(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.annotation.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.annotation.Font
        """
        return self["font"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.annotation.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.annotation.Hoverlabel
        """
    ...
    def _prop_descriptions(self):
        ...
        height
            ...
            will be clipped.
        hoverlabel
            :class:`new_plotly.graph_objects.layout.scene.annotation.Ho
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.scene.Annotation`
        align
            Sets the horizontal alignment of the `text` within the
            box. Has an effect only if `text` spans two or more
            lines (i.e. `text` contains one or more <br> HTML tags)
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.scene.Annotation 
