...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.xaxis.Tickfont`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.xaxis.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of new_plotly.graph_objs.layout.scene.xaxis.Tickformatstop
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.layout.scene.xaxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.xaxis.Tickformatstop`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.xaxis.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.scene.xaxis.Title`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.scene.xaxis.Title
        """
        return self["title"]
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            A tuple of :class:`new_plotly.graph_objects.layout.scene.xa
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :class:`new_plotly.graph_objects.layout.scene.xaxis.Title`
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.scene.XAxis`
        autorange
            Determines whether or not the range of this axis is
            computed in relation to the input data. See `rangemode`
            for more info. If `range` is provided, then `autorange`
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.scene.XAxis 
