...
class Hoverlabel(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.layout.annotation.hoverlabel.Font`
        ...
        Returns
        -------
        new_plotly.graph_objs.layout.annotation.hoverlabel.Font
        """
        return self["font"]
    ...
    def __init__(self, arg=None, bgcolor=None, bordercolor=None, font=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`new_plotly.graph_objs.layout.annotation.Hoverlabel`
        bgcolor
            Sets the background color of the hover label. By
            default uses the annotation's `bgcolor` made opaque, or
            white if it was transparent.
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.layout.annotation.Hoverlabel 
