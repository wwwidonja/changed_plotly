...
class Mesh3d(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.ColorBar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                title
                    :class:`new_plotly.graph_objects.mesh3d.colorbar.Ti
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.ColorBar
        """
    ...
    def contour(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.Contour`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.Contour
        """
        return self["contour"]
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.Hoverlabel
        """
    ...
    def lighting(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.Lighting`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.Lighting
        """
    ...
    def lightposition(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.Lightposition`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.Lightposition
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.mesh3d.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.mesh3d.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Mesh3d`
        alphahull
            Determines how the mesh surface triangles are derived
            from the set of vertices (points) represented by the
            `x`, `y` and `z` arrays, if the `i`, `j`, `k` arrays
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Mesh3d 
