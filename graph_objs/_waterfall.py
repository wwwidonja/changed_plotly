...
class Waterfall(_BaseTraceType):
    ...
    def connector(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Connector`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                line
                    :class:`new_plotly.graph_objects.waterfall.connecto
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Connector
        """
    ...
    def decreasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Decreasing`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.waterfall.decreasi
                    ng.Marker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.waterfall.Decreasing
        """
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Hoverlabel
        """
    ...
    def increasing(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Increasing`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.waterfall.increasi
                    ng.Marker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.waterfall.Increasing
        """
    ...
    def insidetextfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Insidetextfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Insidetextfont
        """
    ...
    def outsidetextfont(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Outsidetextfont`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Outsidetextfont
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Stream
        """
        return self["stream"]
    ...
    def textfont(self):
        ...
        Returns
        -------
        new_plotly.graph_objs.waterfall.Textfont
        """
    ...
    def totals(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.waterfall.Totals`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                marker
                    :class:`new_plotly.graph_objects.waterfall.totals.M
                    arker` instance or dict with compatible
                    properties

        Returns
        -------
        new_plotly.graph_objs.waterfall.Totals
        """
        return self["totals"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Waterfall`
        alignmentgroup
            Set several traces linked to the same position axis or
            matching axes to the same alignmentgroup. This controls
            whether bars compute their positional range dependently
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Waterfall 
