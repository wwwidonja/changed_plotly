...
class Surface(_BaseTraceType):
    ...
    def colorbar(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.ColorBar`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                title
                    :class:`new_plotly.graph_objects.surface.colorbar.T
    ...
    def contours(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.Contours`
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                x
                    :class:`new_plotly.graph_objects.surface.contours.X
                    ` instance or dict with compatible properties
                y
                    :class:`new_plotly.graph_objects.surface.contours.Y
                    ` instance or dict with compatible properties
                z
                    :class:`new_plotly.graph_objects.surface.contours.Z
                    ` instance or dict with compatible properties
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.Hoverlabel`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.surface.Hoverlabel
        """
    ...
    def lighting(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.Lighting`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.surface.Lighting
        """
    ...
    def lightposition(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.Lightposition`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.surface.Lightposition
        """
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`new_plotly.graph_objs.surface.Stream`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        new_plotly.graph_objs.surface.Stream
        """
        return self["stream"]
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :class:`new_plotly.graph_objs.Surface`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `colorscale`. In case `colorscale` is unspecified or
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the new_plotly.graph_objs.Surface 
