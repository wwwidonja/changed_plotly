...
%s"""
    ...
    def select_traces(self, selector=None, row=None, col=None, secondary_y=None):
        ...
        row, col: int or None (default None)
            ...
            created using new_plotly.subplots.make_subplots.  If None
...
because subplot does not have a secondary y-axis"""
    ...
    def plotly_restyle(self, restyle_data, trace_indexes=None, **kwargs):
        ...
        restyle_data : dict
            ...
            >>> import new_plotly.graph_objects as go
...
""".format(
    ...
    def add_trace(
        ...
        trace : BaseTraceType or dict
            Either:
              - An instances of a trace classe from the new_plotly.graph_objs
                package (e.g new_plotly.graph_objs.Scatter, new_plotly.graph_objs.Bar)
              - or a dicts where:
        ...
        >>> from new_plotly import subplots
        >>> import new_plotly.graph_objs as go
    ...
    def add_traces(
        ...
        data : list[BaseTraceType or dict]
            ...
            Trace specifications may be either:
              ...
              - Instances of trace classes from the new_plotly.graph_objs
                package (e.g new_plotly.graph_objs.Scatter, new_plotly.graph_objs.Bar)
              - Dicts where:
    ...
    def print_grid(self):
        ...
        with new_plotly.tools.make_subplots.
        """
        if self._grid_str is None:
            raise Exception(
                "Use new_plotly.tools.make_subplots " "to create a subplot grid."
            )
    ...
    def append_trace(self, trace, row, col):
        ...
        new_plotly.tools.make_subplots, and can be viewed with the `print_grid`
        method
...
""",
    ...
    def get_subplot(self, row, col, secondary_y=False):
        ...
        subplot
            ...
            * new_plotly.graph_objs.layout.Scene: if subplot type is 'scene'
            * new_plotly.graph_objs.layout.Polar: if subplot type is 'polar'
            * new_plotly.graph_objs.layout.Ternary: if subplot type is 'ternary'
            * new_plotly.graph_objs.layout.Mapbox: if subplot type is 'ternary'
            ...
            * SubplotXY namedtuple with `xaxis` and `yaxis` fields:
              if subplot type is 'xy'.
                - xaxis: new_plotly.graph_objs.layout.XAxis instance for subplot
                - yaxis: new_plotly.graph_objs.layout.YAxis instance for subplot
        """
...
""".format(
    ...
    def _is_key_path_compatible(key_path_str, plotly_obj):
        ...
        the specified new_plotly object for the purpose of relayout/restyle
        operation
        """
    ...
    def frames(self):
        ...
        Returns
        -------
        tuple[new_plotly.graph_objs.Frame]
        """
        return self["frames"]
    ...
    # new_plotly.io methods
    # -----------------
    # Note that docstrings are auto-generated in new_plotly/_docstring_gen.py
    def show(self, *args, **kwargs):
        ...
        renderer: str or None (default None)
            ...
            renderers specified in new_plotly.io.renderers.default are used.
        ...
        width: int or float
            ...
            plot is. The default is set in new_plotly.js.
    ...
    def to_json(self, *args, **kwargs):
        ...
        engine: str (default None)
            ...
            new_plotly.io.json.config.default_encoder.
    ...
    def full_figure_for_development(self, warn=True, as_dict=False):
        ...
        Returns
        -------
        new_plotly.graph_objects.Figure or dict
            The full figure
        """
        import plotly.io as pio
    ...
    def to_html(self, *args, **kwargs):
        ...
        include_plotlyjs: bool or string (default True)
            Specifies how the new_plotly.js library is included/loaded in the output
            div string.
            ...
            globally configured to know how to find Plotly.js as 'new_plotly'.
            ...
            document that already loads new_plotly.js. This option is not advised
        ...
        post_script: str or list or None (default None)
            ...
            new_plotly.js figure is associated with.  One application for this script
            is to install custom new_plotly.js event handlers.
    ...
    def write_html(self, *args, **kwargs):
        ...
        include_plotlyjs: bool or string (default True)
            ...
            path and `full_html` is True, then the new_plotly.min.js bundle is copied
            into the directory of the resulting HTML file. If a file named
            new_plotly.min.js already exists in the output directory then this file
            ...
            the new_plotly.min.js bundle in the same directory. This option is
            useful when many figures will be saved as HTML files in the same
            directory because the new_plotly.js source code will be included only
    ...
    def to_image(self, *args, **kwargs):
        ...
        format: str or None
            ...
            If not specified, will default to `new_plotly.io.config.default_format`
        ...
        width: int or None
            ...
            If not specified, will default to `new_plotly.io.config.default_width`
        ...
        height: int or None
            ...
            If not specified, will default to `new_plotly.io.config.default_height`
        ...
        scale: int or float or None
            ...
            If not specified, will default to `new_plotly.io.config.default_scale`
    ...
    def write_image(self, *args, **kwargs):
        ...
        format: str or None
            ...
            will default to `new_plotly.io.config.default_format`
    ...
    def _perform_update(plotly_obj, update_obj, overwrite=False):
        ...
        if update_obj is None:
            ...
            raise ValueError(
                "Unexpected new_plotly object with type {typ}".format(typ=type(plotly_obj))
            )
    ...
    def set_subplots(self, rows=None, cols=None, **make_subplots_args):
        ...
        new_plotly.subplots.make_subplots accepts.
        """
...
class BasePlotlyType(object):
    ...
    def __init__(self, plotly_name, **kwargs):
        ...
        ----------
        plotly_name : str
            The lowercase name of the new_plotly object
        kwargs : dict
    ...
    def plotly_name(self):
        """
        The new_plotly name of the object
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, self.__class__):
            # Require objects to be of the same new_plotly type
            return False
        else:
            # Compare plotly_json representations
    ...
    def _raise_on_invalid_property_error(self, _error_to_raise=None):
        ...
        def _ret(*args):
            ...
            if invalid_props:
                ...
                module_root = "new_plotly.graph_objs."
...
""".format(
    ...
    def to_plotly_json(self):
        """
        Return new_plotly JSON representation of object as a Python dict
...
class BaseLayoutType(BaseLayoutHierarchyType):
    ...
    # Dynamic properties
    # ------------------
    # Unlike all other new_plotly types, BaseLayoutType has dynamic properties.
...
class BaseTraceType(BaseTraceHierarchyType):
    ...
    def on_hover(self, callback, append=False):
        ...
        instance of new_plotly.graph_objs.FigureWidget and it is displayed in an
        ...
        callback
            ...
            - this trace
            - new_plotly.callbacks.Points object
            - new_plotly.callbacks.InputDeviceState object
        ...
        >>> import new_plotly.graph_objects as go
        >>> from new_plotly.callbacks import Points, InputDeviceState
    ...
    def on_selection(self, callback, append=False):
        ...
        callback
            ...
            - this trace
            - new_plotly.callbacks.Points object
            - new_plotly.callbacks.BoxSelector or new_plotly.callbacks.LassoSelector
        ...
        >>> import new_plotly.graph_objects as go
        >>> from new_plotly.callbacks import Points
        >>> points = Points()
    ...
    def _dispatch_on_selection(self, points, selector):
        ...
        if "selectedpoints" in self:
            ...
            # restyle event is emitted by new_plotly.js on selection events
