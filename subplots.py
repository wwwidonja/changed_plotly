...
def make_subplots(
    ...
    **kwargs
    ...
    """
    Return an instance of new_plotly.graph_objs.Figure with predefined subplots
    ...
    >>> from new_plotly.subplots import make_subplots
...
for the specs argument to new_plotly.subplots.make_subplots for more information.
"""
            )
...
See the docstring for the specs argument to new_plotly.subplots.make_subplots 
