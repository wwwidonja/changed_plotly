...
directory_script = '<script src="new_plotly.min.js"></script>'
...
class PlotlyOfflineBaseTestCase(TestCase):
    def tearDown(self):
        ...
        try:
            ...
            # also produce new_plotly.min.js
            os.remove(os.path.join(here, "new_plotly.min.js"))
        except OSError:
            pass
...
class PlotlyOfflineTestCase(PlotlyOfflineBaseTestCase):
    ...
    def _read_html(self, file_url):
        ...
        in the form e.g. file:///Users/chriddyp/Repos/new_plotly.py/new_plotly-temp.html
        """
    ...
    def test_including_plotlyjs_directory_html(self):
        self.assertFalse(os.path.exists(os.path.join(here, "new_plotly.min.js")))
        ...
        # plot creates new_plotly.min.js in the output directory
        self.assertTrue(os.path.exists(os.path.join(here, "new_plotly.min.js")))
        with open(os.path.join(here, "new_plotly.min.js"), "r") as f:
    ...
    def test_including_plotlyjs_directory_div(self):
        ...
        # plot does NOT create a new_plotly.min.js file in the output directory
        # when output_type is div
        self.assertFalse(os.path.exists("new_plotly.min.js"))
    ...
    def test_plotlyjs_version(self):
        path = os.path.join(
            packages_root, "javascript", "jupyterlab-new_plotly", "package.json"
        )
        with open(path, "rt") as f:
            package_json = json.load(f)
            expected_version = package_json["dependencies"]["new_plotly.js"]
