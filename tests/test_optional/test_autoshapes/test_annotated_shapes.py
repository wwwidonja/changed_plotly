...
# Normally the test is run as part of the test suite for new_plotly.py run using
...
# stored in JSON format (somewhat like the new_plotly.js image tests). Actually only
...
#
#   (new_plotly.py/venv)% WRITE_JSON=1 python path/to/this/file.py
#
...
#
#   (new_plotly.py/venv)% VISUALIZE=1 python path/to/this/file.py
#
