...
class PlotlyRenderer(Renderer):
    """A renderer class inheriting from base for rendering mpl plots in new_plotly.
    ...
    the creation of the JSON structures that get sent to new_plotly.
    ...
    def open_figure(self, fig, props):
        ...
        mouse around a figure in new_plotly, it's set to show the 'closest' point.
    ...
    def open_axes(self, ax, props):
        """Setup a new axes object (subplot in new_plotly).
        ...
        Setting the proper plot domain in new_plotly is a bit tricky. Refer to
        the documentation for mpltools.convert_x_domain and
        mpltools.convert_y_domain.

        Positional arguments:
        ax -- an mpl axes object. This will become a subplot in new_plotly.
        props.keys() -- [
    ...
    def draw_bar(self, coll):
        ...
        to tell new_plotly about this data. Just like draw_line or draw_markers,
        draw_bar translates patch/path information into something new_plotly
        understands.
        ...
        for single_mode in mode.split("+"):
            ...
            if single_mode == "markers" and props.get("markerstyle"):
                ...
                if symbol == "circle":
                    ...
                    # new_plotly also maps many other markers to circle, such as 1,8 and p
                    path = None
                    shape_type = "circle"
                    x0 = -size / 2
                    y0 = size / 2
    ...
    def draw_text(self, **props):
        ...
        Currently, new_plotly uses either 'page' or 'data' to reference
    ...
    def draw_title(self, **props):
        ...
        if len(self.mpl_fig.axes) > 1:
            ...
            self.msg += (
                "          Only one subplot found, adding as a " "new_plotly title\n"
            )
    ...
    def resize(self):
        """Revert figure layout to allow new_plotly to resize.

        By default, PlotlyRenderer tries its hardest to precisely mimic an
        mpl figure. However, new_plotly is pretty good with aesthetics. By
        running PlotlyRenderer.resize(), layout parameters are deleted. This
        lets new_plotly choose them instead of mpl.
